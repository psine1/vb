...
multitimeline
  ...
  .from("#wrap-odometer", 0.75, { scaleX: 0, ease: "power3.out" }, "<")  
  .from("#logo, #cta", 1, { y: 200, ease: "power3.out" }, "<")
  .to("#cta img", 0.75, { scale: 1.125, rotation: 0.05, repeat: -1, yoyo: true, ease: "power2.out" }, "<")

  .from("#innner-odometer", 0.75, { y: 10, autoAlpha: 0, ease: "power3.out" }, "<+0.5")

  .add(animateOdometer("odometer", 93, 1), "<+0.15") 
  
  .to("#wrap-odometer", 0.75, { y: -148, ease: "power2.out" }, "<+1.35")

  .from("[id*='txt-1-']", 0.65, { y: 20, autoAlpha: 0, stagger: 0.2, ease: "power3.out" }, "<+0.5")
  ...
  .to("[id*='txt-1-']", 0.75, { autoAlpha: 0, ease: "power2.out" }, "<+2")
  .to("#mark", 0.75, { autoAlpha: 0, ease: "power2.out" }, "<")
  .from("[id*='txt-2-']", 0.65, { y: 20, autoAlpha: 0, stagger: 0.2, ease: "power3.out" }, "<+0.5")
  .from("#mark2", 0.65, { scaleX: 0, ease: "power3.out" }, "<+0.75")
